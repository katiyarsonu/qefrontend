...
function Login({ setIsAuthenticated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("token", response.data.token);
      setIsAuthenticated(true);
      navigate("/dashboard/home"); // Redirect to home instead of resume-builder
    } catch (err) {
      console.log(err);
      setError("Invalid credentials");
    } finally {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-gradient-to-br from-blue-50 to-gray-100 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="hidden md:block absolute -bottom-16 -left-16 w-64 h-64 bg-blue-600/5 rounded-full blur-2xl"></div>
        <div className="hidden md:block absolute -top-16 -right-16 w-64 h-64 bg-blue-600/5 rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="flex flex-1 flex-col md:flex-row items-center justify-center p-6 z-10">
        ...
        <div className="hidden md:flex md:w-1/2 p-12 items-center justify-center">
          <div className="max-w-md text-gray-800 relative">
            <div className="absolute -left-12 -top-12 w-24 h-24 grid grid-cols-3 gap-2 opacity-50">
              {[...Array(9)].map((_, i) => (
                <div key={i} className="w-2 h-2 rounded-full bg-blue-600/30 animate-pulse" style={{ animationDelay: `${i * 0.1}s` }}></div>
              ))}
            </div>
            ...
            <div className="flex items-center bg-white p-4 rounded-lg shadow-md transition-all hover:shadow-lg">
              ...
              <span className="text-gray-700 font-medium">Trusted by over 1.5M job seekers worldwide</span>
            </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-md bg-white shadow-lg rounded-xl p-8 transition-all hover:shadow-xl relative">
            ...
            <p className="text-center text-gray-600 mb-6">Access your career tools now</p>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all hover:border-blue-400"
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setPassword(e.target.value)}
                    required
                    className="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all hover:border-blue-400 pr-12"
                  />
                  <button
                    type="button"
                    onClick={togglePasswordVisibility}
              ...
              <button
                type="submit"
                className="w-full h-12 bg-blue-600 text-white rounded-lg font-semibold flex items-center justify-center transition-all hover:bg-blue-700 hover:shadow-md transform hover:-translate-y-0.5 disabled:bg-blue-400"
                disabled={isLoading}
              >
                {isLoading ? (
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <button className="h-12 border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50 transition-all hover:border-blue-400">
      ...
      {/* Enhanced Footer */}
      <footer className="bg-blue-600 text-white py-8 px-6 z-10 relative">
        ...
        <div className="mt-8 pt-4 border-t border-blue-500/30 text-center text-sm text-blue-100">
